# test naive bayes and linear SVM classifiers with additional filters
# on the 2005 Congress debate transcripts
...
for train_index, test_index in skf:
	...
	count_vect = CountVectorizer(stop_words=text.ENGLISH_STOP_WORDS.union(additional_stop_words), ngram_range=(2,4))
